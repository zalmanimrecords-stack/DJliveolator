...
/// tags, since filenames/tags are unreliable; artist/title are the fallback match. Pure data. Named
/// distinctly from the catalog's <c>Library.Music.TrackQuery</c> (a different concern).
/// </summary>
...
public sealed record TrackLookupQuery(
    string? Artist = null,
    string? Title = null,
