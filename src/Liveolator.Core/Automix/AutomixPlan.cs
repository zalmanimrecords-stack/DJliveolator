...
/// anything is dispatched: the deck roles, the (possibly auto-shortened) length, and the incoming
/// deck's mix-in point — or a typed refusal.
/// </summary>
    ...
    double MixInSeconds)
{
    ...
    public static AutomixPlan Refused(AutomixRefusal reason)
        => new(reason, FromSlot: -1, ToSlot: -1, PlannedBars: 0, MixInSeconds: 0.0);
}
