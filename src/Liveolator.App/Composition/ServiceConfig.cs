...
public static class ServiceConfig
{
    public static IServiceProvider Build()
    {
        ...
        VisualActionHandler visualHandler = WireVisuals(services, visualClock);
    ...
    // on the actual music — or on the Live tab taps when headless. The starter bank renders the
    // generated placeholder image; a real scene/bank catalog from persistence (doc 13) replaces it later.
    private static VisualActionHandler WireVisuals(IServiceCollection services, IBeatClock liveClock)
    {
        ...
        var visualEngine = new GlVisualPerformanceEngine(BuildStarterBank(), brightnessMacro, liveClock);
