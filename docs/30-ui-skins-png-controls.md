...
`AnalogBackgroundBaker` — a brushed-chrome band over wood planks, drawn deterministically). Pick it in
Settings → *UI theme* (applies on next launch, like other themes). Proof: `artifacts/ui-shots/analog-theme.png`.
