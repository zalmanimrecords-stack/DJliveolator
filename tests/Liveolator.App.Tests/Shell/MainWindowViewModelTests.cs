...
public sealed class MainWindowViewModelTests
{
    ...
    private sealed class FakeStudioSetStore : IStudioSetStore
    {
        ...
        public Task<StudioSet?> LoadAsync(string name, CancellationToken ct = default)
            => Task.FromResult<StudioSet?>(null);
        public Task SaveAsync(StudioSet set, CancellationToken ct = default) => Task.CompletedTask;
    ...
    private static MainWindowViewModel BuildShell()
    {
        ...
        var studio = new StudioViewModel(library, new FakeStudioSetStore());
